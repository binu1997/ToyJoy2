...
//creating Userlist adapter
                                userlist UserAdapter = new userlist(contactus.this, Users);
//attaching adapter to the listview
        ...
        private void CallUpdateAndDeleteDialog(final String userid, String username, final String email, String monumber) {
                ...
                final View dialogView = inflater.inflate(R.layout.update_dalog, null);
...
//Saving the User
                                        ...
                                        Toast.makeText(this, "Please enter a messgage", Toast.LENGTH_LONG).show();
                                }
                        } else {
